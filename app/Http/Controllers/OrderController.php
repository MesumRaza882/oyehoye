...
class OrderController extends Controller
{
    ...
    public function DispatchOrderPostEx(Request $req)
    {
        ...
        try {
            ...
            // get postApi track for warehouse team member
            if ($order->is_warehouseTeam_order) {
                $apiToken =  $req->pickupAddressCode === 'nowshera' ? $order->waoSellerDetail->postEx_apiToken_nowshera : $order->waoSellerDetail->postEx_apiToken;
                $pickupAddressCode = $req->pickupAddressCode === 'nowshera' ? $order->waoSellerDetail->postEx_pickupAddressCode_nowshera : $order->waoSellerDetail->postEx_pickupAddressCode;
            }
