    ...
    <div class="container-fluid" style="margin-top: 70px;">
        <div class="row">
            @foreach($products as $index => $item)
                <div class="col-4 p-1">
                    <div class="w-100 bg_yellow m-0">
                        <h5 class="text-center">{{$item->autoSaleItemNow}}</h5>
                    </div>
                    <div class="full-height-video mb-3" style="margin-top: -8px;">
            ...
            <div class="product_place_order py-2 d-flex justify-content-between">
                ...
                <a href="{{route('product.NewArrivals')}}"  class="white_text">
