                 ...
                 <table class="table table-hover table-striped w-100">
                  ...
                  <tbody>
                    @foreach($reviews as $review)
                      <tr>
                        <td><a href="{{ route('singleUser', $review->user->id) }}">{{ $review->cus_name }}</a></td>
                        <td>{{ $review->user->phone }}</td>
                        <td><a href="https://wa.me/{{ $review->user->whatsapp }}?text=" class="text-white btn-success btn btn-sm" target="_blank">{{ $review->user->whatsapp }}</a></td>
                        <td>{{ $review->desc }}</td>
                        <td>
