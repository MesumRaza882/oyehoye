...
<nav class="navbar navbar-expand-lg main-navbar sticky">
  <div class="form-inline mr-auto">
    <ul class="navbar-nav mr-3">
      ...
      <li>
        <p class="fw-bold {{auth()->user()->balance > 0 ? 'bg-success' : 'bg-danger'}} p-2 badge mt-2">{{number_format(auth()->user()->balance)}}</p>
      </li>
      @if (!Route::is('waoseller.order.create') && !Route::is('waoseller.order.index'))
        <li>
            <a href="{{ route('waoseller.order.create') }}" class="ms-1 btn btn-sm bg-warning text-dark"><i class="fa fa-plus"></i></a>
        </li>
      @endif
      <li>
...
<div class="modal fade" id="exampleModalAddprojectadm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="password" class="form-control" value="" placeholder="Change password">
                          <span class="text-muted py-3">If you want to change password?, use this field</span>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="trax_api_key" class="form-control" value="{{auth()->user()->trax_api_key}}">
                        </div>
                        <span class=" mb-2 text-danger  errr-span"></span>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="trax_pickup_address_id" class="form-control" value="{{auth()->user()->trax_pickup_address_id}}">
                        </div>
                        <span class=" mb-2 text-danger  errr-span"></span>
                      </div>
                      <hr>
                      ...
                      <div class="py-2 card-body">
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="postEx_apiToken" class="form-control" value="{{auth()->user()->postEx_apiToken}}">
                          </div>
                          <span class=" mb-2 text-danger  errr-span"></span>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <select class="form-control" name="postEx_pickupAddressCode">
                              <option {{ auth()->user()->postEx_pickupAddressCode ? '' : 'selected' }} value="">Select City</option>
                              @for ($i = 1; $i <= 100; $i++) <option value="{{ sprintf('%03d', $i) }}" {{ auth()->user()->postEx_pickupAddressCode === sprintf('%03d', $i) ? 'selected' : '' }}>
                                {{ sprintf('%03d', $i) }}
                                </option>
                                @endfor
                            </select>
                      ...
                      <div class="pt-3 pb-1 text-white card-body bg-dark">
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="postEx_apiToken_nowshera" class="form-control" value="{{auth()->user()->postEx_apiToken_nowshera}}">
                          </div>
                          <span class=" mb-2 text-danger  errr-span"></span>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-3">
                            <p class="mb-0 text-white">Pickup-Address-Code (Nowshera)</p>
                          </div>
                          <div class="col-sm-9">
                            <select class="form-control" name="postEx_pickupAddressCode_nowshera">
                              <option {{ auth()->user()->postEx_pickupAddressCode_nowshera ? '' : 'selected' }} value="">Select City</option>
                              @for ($i = 1; $i <= 100; $i++) <option value="{{ sprintf('%03d', $i) }}" {{ auth()->user()->postEx_pickupAddressCode_nowshera === sprintf('%03d', $i) ? 'selected' : '' }}>
                                {{ sprintf('%03d', $i) }}
                                </option>
                                @endfor
                            </select>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="mnp_username" class="form-control" value="{{auth()->user()->mnp_username}}">
                        </div>
                        <span class=" mb-2 text-danger  errr-span"></span>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="mnp_password" class="form-control" value="{{auth()->user()->mnp_password}}">
                        </div>
                        <span class=" mb-2 text-danger  errr-span"></span>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="locationID" class="form-control" value="{{auth()->user()->locationID}}">
                        </div>
                        <span class=" mb-2 text-danger  errr-span"></span>
                      </div>
                      <hr>
                      ...
                      <button type="submit" class=" mt-4 btn btn-success ms-auto d-block">Update Profile</button>
                    </div>
                  </div>
                </div>
              </div>
