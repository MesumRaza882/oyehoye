...
<head>
    ...
    <meta property="og:image" content="https://oyehoyebridalhouses.com/slip/1703317757.jpeg"> <!-- Placeholder image URL -->
    <meta property="og:url" content="https://oyehoyebridalhouses.com">
    <!-- bootstrap css -->
    ...
    <!-- Custom style CSS -->
    <link rel="stylesheet" href="{{asset('assets/css/custom.css?v=1.1.3')}}">
    <!-- dataTable css file -->
    ...
    <style>
        ...
        .card{box-shadow:unset !important; border-radius:20px !important; padding: 1.2rem 1.2rem !important;}
