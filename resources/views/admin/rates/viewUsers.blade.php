        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                ...
                <div class="row justify-content-between">
                    <!-- total record count -->
                    <div class="col-auto">
                        <p class="flaot-left d-inline-block p-2 bg-primary text-white">Users:<span
                                class="ms-1">{{ $total_users }}</span></p>
                        <p class="flaot-left d-inline-block p-2 bg-success"><a class="text-white"
                                href="{{ url('/m-o-v-e-t-o-a-d-m-i-n-e-x-p-o-r-t-m-y-c-o-n-t-a-c-t-l-i-s-t') }}">Export
                                VCF</a></p>
                        <p class="flaot-left d-inline-block p-2 bg-success"><a class="text-white"
                                href="{{ url('/check-notification') }}">Check Nottification</a></p>
                    </div>
                    <!-- filter -->
                    <div class="col-12 mb-3">
                        <form method="GET" action="{{ route('viewUsers') }}" id="search-form">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <!-- select order Type -->
                                <div class="col-lg-3 mb-2">
                                    <label class="pe-1">Select Orders Type</label>
                                    <select name="orderType" class="form-control me-2">
                                        <option value="">All</option>
                                        <option value="general" @if (request()->get('orderType') == 'general') selected @endif>
                                            General Orders</option>
                                        <option value="app" @if (request()->get('orderType') == 'app') selected @endif>App
                                            Orders</option>
                                    </select>
                                </div>
                                ...
                                <!-- select Status -->
                                <div class="col-lg-3 mb-2">
                                    <label class="pe-1">Is Reseller</label>
                                    <select name="is_reseller" class="form-control me-2">
                                        <option value="-1">Select</option>
                                        <option value="0" @if (request()->get('is_reseller') == 0) selected @endif>
                                            Customer</option>
                                        <option value="1" @if (request()->get('is_reseller') == 1) selected @endif>
                                            Resellers</option>
                                    </select>
                                </div>
                                ...
                                <!-- filter by city -->
                                <div class="col-lg-3 mb-2">
                                    <label class="pe-1">Select Reseller/Admin</label>
                                    <select name="admin_id" class="form-control me-2">
                                        <option value="">Select</option>
                                        @foreach ($admins as $admin)
                                            <option value="{{ $admin->id }}"
                                                @if (request()->get('admin_id') == $admin->id) selected @endif>{{ $admin->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-auto my-1 mt-2 ms-auto">
                                    ...
                                    <button type="submit" name="vcf" value="1" class="mx-2 btn btn-sm btn-success">
                                        Filtered VCF
                                    </button>
