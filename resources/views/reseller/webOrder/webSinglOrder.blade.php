...
@section('content')
@section('title') Single Order @endsection
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card card-body">
                                <h6 style="font-weight: 700;">Basic Products Price : <span id="basicProductCount" style="font-weight: 16px;">({{$order->orderitems->sum('qty')}}x)</span> = <span style="font-weight: 800;" class="text-warning">{{$purchaseTotal - $perOrderCharge - ($order->orderitems->sum('qty') * $perProductCharge)}}</span></h6>
                                <h6 class="mb-2" style="font-weight: 700;">Per Product Charges: <span id="perProductCount" style="font-weight: 800;">{{$order->orderitems->sum('qty')}} X {{$perProductCharge}}</span> = <span id="perProductAmount" style="font-weight: 800;" class="text-warning">{{$order->orderitems->sum('qty') * $perProductCharge}}</span></h6>
                                <h6 class="mb-2" style="font-weight: 700;">Order Charges: <span style="font-weight: 800;" class="text-warning" id="orderCharges">{{$perOrderCharge}}</span></h6>
                                <h6 class="mb-0 pb-0" class="text-center border border-primary">Total Amount : <span class="text-warning" id="totalAmountPurchse">{{$purchaseTotal}}</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12 mx-auto">
                <section class="section">
                    <div class="section-body">
                        <div class="card">
                            <form method="POST" enctype="multipart/form-data" action="{{route('waoseller.updateWebOrder',$order->id)}}">
                                @csrf
                                <!--card Body-->
                                <div class="card-body">
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col-auto">
                                            <a href="javascript:history.go(-1)" class="btn btn-sm text-white btn-primary">
                                                <i class="fa-solid fa-arrow-left"></i>
                                            </a>
                                            <p class="d-inline mx-2">Order-id
                                        ...
                                        <div class="col-auto d-flex align-items-center">
                                            ...
                                            <p class="badge bg-primary p-2 ms-1 text-white d-sm-block d-none">{{$order->status}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-auto">
                                            <div class="form-group">
                                                ...
                                                <p class="pb-2 text-center" style="border-bottom:1px solid #bfb5b5;">
                                                    <a href="{{route('waoseller.editUser',$order->userdetail->id)}}" class="btn btn-outline-primary btn-sm">{{$order->name}}</a>
                                                    <span class="badge {{ $order->userdetail->status == 1 ? 'bg-danger' : 'd-none' }}">
                                        ...
                                        <div class="col-sm-2 col-auto">
                                            <div class="form-group">
                                                ...
                                                <p class="pb-2 text-center" style="border-bottom:1px solid #bfb5b5;">{{$order->citydetail ? $order->citydetail->c_city_name : $order->city}}</p>
                                            </div>
                                        </div>
                                        <!--address-->
                                        ...
                                        <div class="col-auto">
                                            <div class="form-group">
                                                ...
                                                <p class="pb-1 text-center" style="border-bottom:1px solid #bfb5b5;">
                                                    <a href="https://wa.me/+92{{$order->userdetail->whatsapp}}?text=Hi%20Welcome%20to%20WAO" target="_blank" class=" pb-0 btn text-success fw-bold">
                                        ...
                                        <div class="col-auto">
                                            <div class="form-group">
                                                ...
                                                <p class="pb-2 text-center" style="border-bottom:1px solid #bfb5b5;">{{$order->phone}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="pt-2 d-flex">
                                            <button class="border btn btn-sm btn-info view_notes ms-auto"><i class="fa-solid fa-eye"></i> View Notes </button>
                                            <hr>
                                        </div>
                                        <!--Notes-->
                                            ...
                                            <table class="table table-bordered table-hover table-md-responsive">
                                                <tbody class="text-center">
                                                    <tr class="{{$order->note != null ? '' : 'd-none'}}">
                                                        <td>{{$order->note}} - <span class="text-info">{{$order->created_at->format('j M, Y \a\t g:i A')}}</span></td>
                                                    </tr>
                                                    @foreach($order->notes as $note)
                                                    <tr>
                                                        <td>{{$note->note}} - <span class="text-info">{{$note->created_at->format('j M, Y \a\t g:i A')}}</span></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="row my-2  align-items-start justify-content-end">
                                        ...
                                        <div class="col-auto">
                                            <button class=" border btn border-success view_user_orders ms-auto btn-sm"><i class="fa-solid fa-eye"></i> View Last 10 Orders</button>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <!--customer orders-->
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="{{ $pre_order->is_blocked_customer_order == 1 ? 'text-danger': ''}}">
                                                                {{ $pre_order->is_blocked_customer_order == 1 ? 'Fake': 'Real'}}<br>
                                                                <span class="fw-bold">{{ $pre_order->courier_tracking_id}}</span>
                                                            </td>
                                                            <td class="{{ $pre_order->status == 'DISPATCHED' ? 'text-success': ''}}">
                                                                <span class="fw-bold {{ $pre_order->status == 'CANCEL' ? 'text-danger': ''}}">{{$pre_order->status}}</span>
                                                            </td>
                                                            <td><span class="fw-bold">{{$pre_order->orderitems_count}}</span></td>
                                                            <td>{{$pre_order->grandTotal}} /Rs</td>
                                                            <td>
                                                                <span class="fw-bold">{{$pre_order->date}}</span>
                                                                <span class="text-secondary ps-2">{{$pre_order->time}}</span>
                                                            </td>
                                    ...
                                    <div class="row">
                                        <div class="py-2">
                                            <h5 class="mb-4">Order Items Deatils
                                                <a style="cursor: none;" class="btn btn-outline-primary mx-1 py-1 mt-2 mt-sm-0 btn-sm">
                                                    Order-Items<span class="badge rounded-pill bg-light text-dark">{{count($order->orderitems)}} </span>
                                                </a>
                                                <a style="cursor: none;" class="btn btn-outline-secondary mx-1 py-1 mt-2 mt-sm-0 btn-sm fw-bold">
                                                    Items-Quantity<span class="badge rounded-pill bg-light text-success">{{$order->orderitems->sum('qty')}} </span>
                                                </a>
                                            </h5>
                                            <hr>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="d-lg-flex py-lg-0 py-2 align-items-center position-relative">
                                                                <!-- delete record modal -->
                                                                <!-- @section('delete_modal_footer')
                                                                <form method="POST" id="delete_order_item_form">
                                                                    @csrf
                                                                    <input hidden type="text" id="delete_order_item_id" name="delete_order_item_id">
                                                                ...
                                                                @endsection -->
                                                                <!-- end Delete Modal -->
                                                                <!-- <button class="btn btn-sm btn-danger text-white del_order_item" value="{{$item->id}}">
                                                                    <i class="fa fa-trash"></i>
                                                                </button> -->
                                                                <span class="px-2">
                                                                    <span class="fw-bold badge bg-primary" style="font-size:14px !important;">( x {{$item->qty }})</span>
                                                                    {{$item->product->name}}
                                                                </span>
                                                                ...
                                                                <span class=" {{$item->is_dc_free == 0 ? 'd-none' : ''}} position-absolute  translate-middle  bg-success border border-light rounded-circle" style="top:18%; padding:6px;"></span>
                                                            </td>
                                                            <td>Rs {{$item->price}}</td>
                                                            <!-- <td>Rs {{$item->purchase}}</td> -->
                                                            <!-- <td>Rs {{$item->profit}}</td> -->
                                                            <td class="position-relative {{$item->discount > 0 ? 'fw-bold text-warning' : '' }}"> {{$item->discount > 0 ? 'Rs: '.$item->discount : '0' }}
                                                                <span class="position-absolute badge bg-warning top-100 {{$item->is_dc_free == 0 ? 'd-none' : ''}}">DC</span>
                                                            </td>
                                                            <td>
                                                                <span class="fw-bold"> Rs: {{($item->price * $item->qty )}}</span>
                                                            </td>
                                                            <!-- <td>
                                                                @php
                                                                $profit = ($item->profit * $item->qty ) - ($item->discount * $item->qty)
                                                                @endphp
                                                                <span class="fw-bold {{$profit < 0 ? 'text-danger':'text-success'}}"> Rs: {{$profit}}</span>
                                                            </td> -->
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                    ...
                                    <div class="row mt-3 justify-content-end">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <a target="_blank" href="{{ $order->slip }}"><img src="{{ $order->slip }}" alt="slip-order" class="rounded-circle" width="150px" height="120px"></a>
                                            </div>
                                        </div>
                                        @endif
                                        <!--Amount-->
                                        ...
                                        <div class="col-lg-6 row">
                                            <div class="col-sm-3 col-xs-6 px-0">
                                                <div class="form-group">
                                                    <label><i class="me-1 fa-solid fa-file-invoice"></i> Grand Total</label>
                                            ...
                                            <div class="col-sm-3 col-xs-6 px-0">
                                                <div class="form-group ms-1">
                                                    <label><i class="me-1 fa-solid fa-file-invoice"></i> Grand Profit</label>
                                                    <input class="form-control" required name="grandProfit" value="{{$order->grandProfit}}" />
                                                </div>
                                            </div>
                                ...
                                <div class="card-footer text-right pt-0">
                                    ...
                                    <div class="row d-flex justify-content-between">
                                        <div class="col-auto text-start">
                                            <h5>Order Status</h5>
                                            <p class=" mx-2 fs-6 badge p-2 {{($order->status == 'CANCEL') ? 'bg-danger' : (($order->status == 'DELIVERED' || $order->status == 'DISPATCHED') ? 'bg-success' : 'bg-primary')}}">
                                                <span class="fw-bold  ">{{$order->status}}</span>
                                            </p>
                                            <div class="d-flex align-items-center">
                                                @if (auth()->user()->trax_allow === 1)
                                                    <a @if($currentDayOrder) onclick="confirmDispatch('{{ $currentDayOrder }}', 'dispatched')" @else data-bs-toggle="modal" data-bs-target="#dispatched" @endif class="dec_para_fun btn btn-sm mb-sm-3 mb-2 text-white btn-primary
                                                        {{ $order->tracking_order_type != '' || $order->status == 'DELIVERED' || $order->is_blocked_customer_order == 1 ? 'd-none' : '' }}">
                                                        TRAX-DISPATCH
                                                    </a>
                                                @else
                                                <span class="alert alert-danger text-white p-2">TRAX Not Allowed</span>
                                                @endif

                                                @if (auth()->user()->mnp_alllow === 1)
                                                    <a @if($currentDayOrder) onclick="confirmDispatch('{{ $currentDayOrder }}', 'dispatched-mnp')" @else data-bs-toggle="modal" data-bs-target="#dispatched-mnp" @endif class="
                                                        dec_para_fun btn btn-sm mb-sm-3 mb-2 text-white btn-info
                                                        {{$order->tracking_order_type != '' || $order->status == 'DELIVERED' || $order->is_blocked_customer_order == 1 ? 'd-none' : ''}}">
                                                        MNP-DISPATCH
                                                    </a>
                                                @else
                                                <span class="alert alert-warning p-2 mx-1 text-white">MNP Not Allowed</span>
                                                @endif

                                                @if (auth()->user()->postEx_allow === 1)
                                                    <a @if($currentDayOrder) onclick="confirmDispatch('{{ $currentDayOrder }}', 'dispatched-postEx')" @else data-bs-toggle="modal" data-bs-target="#dispatched-postEx" @endif class="
                                                        dec_para_fun btn btn-sm mb-sm-3 mb-2 text-white btn-dark
                                                        {{$order->tracking_order_type != '' || $order->status == 'DELIVERED' || $order->is_blocked_customer_order == 1 ? 'd-none' : ''}}">
                                                        PostEx-DISPATCH
                                                    </a>
                                                @else
                                                <span class="alert alert-danger text-white p-2">Post-Ex Not Allowed</span>
                                                @endif
                                            </div>
                                        </div>
                                        <!-- detail of editable -->
                                    ...
                                    <!--Status-->
                                    @if (!$order->wao_seller_id)
                                    <div class="row">
                                        <div class="col-lg-4 my-sm-0 my-3">
                                            <select class="form-control text-center fw-bold py-2" name="status">
                                                <option value="">Select Status</option>
                                                <option value="DISPATCHED">
                                                    {{$order->is_blocked_customer_order == 1 ? 'FAKE DISPATCHED ORDER' : 'DISPATCHED ORDER'}}
                                                </option>

                                                <option value="CANCELHOLD">
                                                    <span>
                                                        <span>{{$order->is_blocked_customer_order == 1 ? 'FAKE & CANCEL ORDER' : 'HOLD & CANCEL ORDER'}}</span>
                                                    </span>
                                                </option>

                                                <option value="BLOCK_HOLD" class="{{$order->is_blocked_customer_order == 1 ? 'd-none' : ''}}">
                                        ...
                                        <center>
                                            <div class="col-auto mt-2">
                                                <input type="hidden" name="customer_id" value="{{$order->userdetail->id}}" />
    ...
    $(document).on('click', '.view_courier_information_div', function(e) {
     ...
     function confirmDispatch(currentDayOrder, openDispatchModal) {
        ...
        if (currentDayOrderStatus === 'returned') {
            ...
            swalText = 'User last Order is returned. Are you sure you want to dispatch a new order?<br><br>' + orderDetails;
        } else {
            swalTitle = 'Duplicate Order Confirmation';
            swalText = 'You have existing orders for today. Do you still want to dispatch a new order?<br><br>' + orderDetails;
        }
